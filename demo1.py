...
def main():
    ...
    # print(question_features.shape)  # (1, 30, 300)
    # print(image_features.shape)     # (1, 4096)
    # print(question_features, image_features)
    ...
    # print(y_sort_index[0, -5:])
    # print(reversed([558, 229, 58, 289, 902]))
